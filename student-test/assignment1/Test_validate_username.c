...
void test_validate_my_username()
{
    ...
    char* username_from_malloc = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_from_function, username_from_malloc, "Username in conf file does not match my_username()");
//    TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!");
    free(username_from_malloc);
}
